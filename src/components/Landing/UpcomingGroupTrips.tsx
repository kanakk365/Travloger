  ...
  return (
    <section className="w-full bg-white px-4 sm:px-6 md:px-10 lg:px-[80px] py-16">
      <div className="max-w-[1400px] mx-auto flex flex-col items-center text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-16 max-w-[1200px]">
          {tabs.map((tab) => (
            <button
              key={tab}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-[1240px]">
          {trips.map((trip, idx) => (
            <div
              key={idx}
              className="bg-white rounded-3xl overflow-hidden flex flex-col shadow-xl group transition-transform duration-300 hover:-translate-y-2"
            >
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-black text-white py-[12px] px-6 text-[15px] font-medium z-10">
                  <div className="flex justify-between items-center w-full">
                    <div className="flex items-center gap-[8px]">
                      <span className="text-[16px] leading-none mb-0.5 opacity-90">📅</span>
                      {trip.dates[0]}
                    </div>

                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[20px] h-[20px] text-white">
                      <path d="M12 0L13.7 8.3L22 10L13.7 11.7L12 20L10.3 11.7L2 10L10.3 8.3L12 0Z" fill="currentColor"/>
                    </svg>
